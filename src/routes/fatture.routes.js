...
import { createBulkAttives, createBulkPassives, createCosti, createFattureActive, createFatturePassive, createRicavi, deleteByIdCosti, deleteByIdRicavi, deleteCosti, deleteFattures, deleteRicavi, getAllCostis, getAllFattureActive, getAllFatturePassiva, getAllRicavis, getCosti, getFattSequence, getFattureActive, getFatturePassive, getRicavi, updateActive, updateFattSequence, updateFatture, upsertCostiOnRegistration, upsertRicaviOnRegistration } from "../controllers/fatture.controller.js";
...
router.patch("/update/invoice/:id", Auth, checkRole(["ADMIN"]), singleUpload("attachment"), updateFatture)
